...
do
  ...
  {~._.~}
                              ...
                              ()~*~()   
                              (_)-(_)   
             _______  _________  __  ___ __________  __ __
            / ___/ / / / ___/ / / / / _ /_  __/ __ \/ //_/
           / /__/ /_/ / /__/ /_/ / / __ |/ / / /_/ / ,<
           \___/\____/\___/\____/ /_/ |_/_/  \____/_/|_|
...
date +"                           %H:%M:%S %Z"| lolcat
    ...
    echo -e "\e[0;35m23)\e[0m User Banned Multilogin                   (banned user)"
     ...
     echo -e "\e[0;35m25)\e[0m clearcache vps                           (Clear Vps)"
	echo -e "\e[0;35m26)\e[0m Exit                                     (Back)"
	echo ""
